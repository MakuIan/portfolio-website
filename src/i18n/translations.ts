...
export const translations = {
  en: {
    ...
    'hero.desc': 'Building responsive web apps including step-chef, set-point, and NexusFinance.',
    ...
    'contact.placeholder': '[ Add your contact details / form configuration here ]',
  },
  de: {
    'nav.home': 'Startseite',
    ...
    'hero.desc': 'Entwicklung von Projekten wie step-chef, set-point und NexusFinance.',
    ...
    'cv.profileDesc': '[ Füge hier dein persönliches Profil / deine Einleitung hinzu ]',
    'cv.experienceTitle': 'Berufserfahrung',
    'cv.experienceDesc': '[ Füge hier deine Berufserfahrung / Stationen hinzu ]',
    ...
    'contact.placeholder': '[ Füge hier deine Kontaktdaten / dein Formular hinzu ]',
  },
} as const;
